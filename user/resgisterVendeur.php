							...
							<?php		
								...
								{ ?>
									<div class="alert alert-warning alert-dismissible fade show" role="alert">
										<strong>ya bhim !</strong> <?= $_SESSION['message']; ?>.
...
<div class="center">
  ...
  <div class="login">
    <label>
      ...
      <input class="username" type="text" autocomplete="on"  name="name" placeholder="Entrez votre nom"/>
    </label>
    <label>
      <div class="fa fa-phone"></div>
      <input class="username" type="number" autocomplete="on"  name="phone" placeholder="+216 *** *** ***"/>
    </label>
    <label>
      <div class="fa fa-phone"></div>
    ...
    <label>
      <div class="fa fa-address"></div>
      <input class="username" type="text" autocomplete="on"  name="address" placeholder="Entrez votre address"/>
    </label>
    
    <label>
      <div class="fa fa-commenting"></div>
      <input class="password" type="password" autocomplete="off" name="password" placeholder="Entrez votre mot de passe"/>
      </label>  
      <label>
      <div class="fa fa-commenting"></div>
      <input class="password" type="password" autocomplete="off" name="cpassword" placeholder="Conformier votre mot de passe"/>
      <button class="password-button">show</button>
    
    </label>
    <button class="login-button"  type="submit" name="registerVendeur_btn" >Se connecter</button>
  </div>
