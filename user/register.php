...
<form action="functions/authcode.php" method="POST">
    ...
    <div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Nom</label>
		<input type="text" id="loginEmail" maxlength="254" name="name"/>
		<p class="helper helper1">Entrez votre nom</p>
	</div>
    <div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">téléphone</label>
		<input type="number" id="loginEmail" maxlength="254" name="phone"/>
		<p class="helper helper1">Entrez votre numéro de téléphone</p>
	</div>
    <div class="inputGroup inputGroup1">
	...
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">confirm mot de passe</label>
	...
	<div class="inputGroup inputGroup3">
		<button id="login" type="submit" name="register_btn" >S’enregistrer</button>
	</div>	
</form>
