                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <label class="mb-0">Nom</label>
                                <input type="text" name="name" class="form-control mb-2" placeholder="Enter Category name" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <label class="mb-0">Small Description</label>
                                <textarea name="small_description" placeholder="Enter Category Small Description" required rows="3" class="form-control mb-2"></textarea>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" name="add_product_btn">Enregister</button>
                            </div>
                        </div>
                        </form>
