                    ...
                    if(mysqli_num_rows($product) > 0)
                    {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                <div class="col-md-12">
                                    <label class="mb-0">Select Categories</label>
                                    ...
                                    <label class="mb-0">Nom</label>
                                        <input type="text" name="name" value="<?= $data['name']; ?>" class="form-control mb-2" placeholder="Enter Categories nom" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                    <label class="mb-0">Petit Description</label>
                                        <textarea name="small_description" placeholder="Enter Category petit Description" required rows="3" class="form-control mb-2"><?= $data['small_description']; ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <label class="mb-0">Original Prix</label>
                                        <input type="text" name="original_price" value="<?= $data['original_price']; ?>" class="form-control mb-2" required placeholder="Enter Products Price">
                                    </div>
                                    <div class="col-md-6">
                                    <label class="mb-0">Vent Prix</label>
                                    <input type="text" name="selling_price" class="form-control mb-2" value="<?= $data['selling_price']; ?>" required placeholder="Enter Selling Price">                                 
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary" name="update_product_btn">Modifer</button>
                                    </div>
                                </div>
                                </form>
