...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">ForsaShop Vendeur</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "products.php"? 'active bg-gradient-primary':''; ?>" href="products.php">
            ...
            <span class="nav-link-text ms-1">Tous les produits</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "Add-product.php"? 'active bg-gradient-primary':''; ?>" href="Add-product.php">
            ...
            <span class="nav-link-text ms-1">Ajouter des produits</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "orders.php"? 'active bg-gradient-primary':''; ?>" href="orders.php">
            ...
            <span class="nav-link-text ms-1">Commandes de vente</span>
          </a>
        </li>
      </ul>
    </div>
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        ...
        href="../user/logout.php">Déconnexion</a>
      </div>
    </div>
  </aside>